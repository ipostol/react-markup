...
var _Frame = require('./helpers/Frame/Frame');

var _Frame2 = _interopRequireDefault(_Frame);

var _NotFound = require('./helpers/NotFound/NotFound');
...
console.log('GOGOGOGOGO'); /* eslint-disable */
...
var req = require.context('components', true, /\.docs\.js$/);
...
for (var key = 0; key < modulesKeys.length; key += 1) {
  ...
  var name = modulesKeys[key].slice(2);
  var component = modules[key].default || modules[key];
